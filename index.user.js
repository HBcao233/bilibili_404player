...
`
        ...
        tag('div', {
          class: 'bpx-player-tooltip-area', children: [
            tag('div', {
              ...
              style: 'left: 320px; bottom: 184px; ',
              children: tag('div', { class: 'text', innerHTML: '' })
            }),
            tag('div', {
              class: 'previous bpx-player-tooltip-item',
              style: 'left: -2px; top: -85px;',
              children: tag('div', { class: 'text', innerHTML: '上一个 ([)' })
            }),
            tag('div', {
              class: 'next bpx-player-tooltip-item',
              style: 'left: 68px; top: -85px;',
              children: tag('div', { class: 'text', innerHTML: '下一个 (])' })
            }),
            tag('div', {
              class: 'fullscreen bpx-player-tooltip-item',
              style: 'right: -5px; top: -85px;',
              children: tag('div', { class: 'text', innerHTML: '进入全屏 (f)' })
            }),
          ]
        }),
      ]
  ...
  function showToast(text) {
    ...
    i.innerText = text;
    i.style.left = 350 - i.clientWidth / 2;
    i.style.bottom = 200 - i.clientHeight / 2;
    i.style.opacity = 1;
